...
import 'package:ajmanbank/Model/ResponseModel/RegistrationFirstScreenRegModel.dart';
...
class PendingController extends GetxController with StateMixin {
  ...
  onInit() async {
    ...
    PendingList(fromDate, toDate, false, false, null, null);
  }
  ...
  PendingList(String? fromDate, String? toDate, bool? filter, bool isPagination,
