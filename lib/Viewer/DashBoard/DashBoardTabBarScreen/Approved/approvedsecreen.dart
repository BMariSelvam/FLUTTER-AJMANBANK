...
class _ApprovedScreenState extends State<ApprovedScreen> {
  late ApproveController _controller;
  ...
  void initState() {
    ...
    super.initState();
    _controller = Get.put(ApproveController());
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ApproveController>(builder: (logic) {
      return Container(
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              Expanded(
                child: (_controller.ApprovedListSize != 0)
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          String? approvedOnDateTimeString = item.approvedOn;
