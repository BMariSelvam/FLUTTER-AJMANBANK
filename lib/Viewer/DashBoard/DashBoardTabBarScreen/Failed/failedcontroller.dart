...
class FailedController extends GetxController with StateMixin {
  RxBool isFailedClick = false.obs;
  ...
  onInit() async {
    ...
    FailedList(fromDate, toDate,false,false,null , null);
  }
  ...
  FailedList(String? fromDate, String? toDate,bool? filter,bool isPagination, String? fromAmount, String? toAmount) async {
