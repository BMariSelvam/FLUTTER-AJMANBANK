...
class _FailedScreenState extends State<FailedScreen> {
  late FailedController _controller;
  ...
  void initState() {
    ...
    super.initState();
    _controller = Get.put(FailedController());
  ...
  Future<void> _scrollListener() async {
    ...
    if (maxScroll - currentScroll <= _scrollThreshold) {
      if (_controller.currentPage <= _controller.totalPages && !_controller.status.isLoadingMore) {
        await _controller.FailedList(_controller.fromDate, _controller.toDate, false,true,null, null);
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<FailedController>(builder: (logic) {
      return Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              Expanded(
                child:  (_controller.FailedSize != 0)
                    ? ListView.builder(
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        _controller.FailedList(_controller.withOutEadate,_controller.withOutFDate,false,false,null,null);
