...
class ProcessedController extends GetxController with StateMixin {
  RxBool isProcessClick = false.obs;
  ...
  onInit() async {
    ...
    processList(fromDate, toDate,false,false,null,null);
  }
  ...
  processList(String? fromDate, String? toDate,bool? filter,bool isPagination, String? fromAmount, String? toAmount) async {
    ...
    await NetworkManager.post(
      ...
      if (response != null) {
        if (response['statusCode'] == "0000") {
          ...
          ProcessListSize = response['listSize'];
          change(null, status: RxStatus.success());
