...
class RejectedController extends GetxController with StateMixin {
  RxBool isRejectClick = false.obs;
  ...
  RxBool isPendingClick = false.obs;
  ...
  onInit() async {
    ...
    RejectedList(fromDate, toDate,false,false,null,null);
  }
  ...
  RejectedList(String? fromDate, String? toDate,bool? filter,bool isPagination,
      String? fromAmount, String? toAmount) async {
    ...
    await NetworkManager.post(
      ...
      if (response != null) {
        if (response['statusCode'] == "0000") {
          ...
          RejectedListSize = response['listSize'];
