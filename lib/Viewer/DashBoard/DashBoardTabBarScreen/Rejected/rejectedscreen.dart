import 'package:ajmanbank/Viewer/DashBoard/DashBoardTabBarScreen/Rejected/rejectedcontroller.dart';
...
class _RejectedScreenState extends State<RejectedScreen> {
  late RejectedController _controller;
  ...
  void initState() {
    ...
    super.initState();
    _controller = Get.put(RejectedController());
  ...
  Future<void> _scrollListener() async {
    ...
    if (maxScroll - currentScroll <= _scrollThreshold) {
      if (_controller.currentPage <= _controller.totalPages && !_controller.status.isLoadingMore) {
        await _controller.RejectedList(_controller.fromDate, _controller.toDate, false,true,null,null);
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RejectedController>(builder: (logic)
    {
      return Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              Expanded(
                child:  (_controller.RejectedListSize != 0)
                    ? ListView.builder(
                  controller: _scrollController,
                    shrinkWrap: true,
                    itemCount: search.isEmpty ? _controller.pendingListmodel.length : filterList(search).length,
                    itemBuilder: (context, index) {
                      final item = search.isEmpty ? _controller.pendingListmodel[index] : filterList(search)[index];
                      String? originalDateTimeString = item.uploadedOn;
                      DateTime parsedDateTime = DateTime.parse(originalDateTimeString!);
                      String? rejectedOnDateTimeString = item.rejectedOn;
                      DateTime rejectedOnDateTime = DateTime.parse(rejectedOnDateTimeString!);
                      return Column(
                        children: [
                          ExpansionTile(
                            title: Column(
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '${rejectedOnDateTime.toLocal().toString().split('.')[0]}',
                                          style: TextStyle(
                                            fontFamily: MyFont.myFont,
                                          ),
                                        ),
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        _controller.RejectedList(_controller.withOutEadate,_controller.withOutFDate,false,false,null,null);
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            keyboardType: TextInputType.numberWithOptions(decimal: true),                              autovalidateMode: AutovalidateMode.onUserInteraction,
                              decoration: InputDecoration(
                        ...
                        SizedBox(
                          ...
                          child: TextFormField(
                            controller:
                            _controller.toAmountController,
                            inputFormatters: [
                              DecimalTextInputFormatter(decimalRange: 2, maxDigitsBeforeDecimal: 5)
                            ],
                            keyboardType: TextInputType.numberWithOptions(decimal: true),                            autovalidateMode: AutovalidateMode.onUserInteraction,
                          ...
                          child: TextFormField(
                              ...
                              onTap: () async {
                                showDatePicker(
                                    ...
                                    initialDate:
                                    DateTime.now(),
                                    firstDate: _controller
                                        .fromFilterDate,
                                    lastDate: DateTime.now())
                                    .then((value) {
                                  setState(() {
                                    _controller.ToFilteDate =
                                    value!;
                                    _controller.toDateController
                                        .text =
                                        DateFormat('dd-MM-yyyy')
